...
for fct in range(1, 7):
    ...
    file = open("../../../data_audio/arff/function" + str(fct) + "_128.arff", "r")
    ...
    file.close()
    possibilities = [i for i in range(len(data))]
    test = []
    train = []

    for i in range(300):  # the number of data in the test file
    ...
    file.write("@ATTRIBUTE frames   NUMERIC\n")

    if fct == 1:
        file.write("@ATTRIBUTE arguments1   {mp3, wav, aiff}\n")
