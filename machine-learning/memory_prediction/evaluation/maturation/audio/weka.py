...
PATH = "../data_audio/arff/"  #FOROTHERSFUNCTIONS path for arff file

PATH_RESULT = "../data_audio/res/"  #FOROTHERSFUNCTIONS path for files generate by weka included tests files
