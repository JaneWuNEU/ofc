...
if $build; then 
    ...
    do 
        ...
        rm -f $func.zip 
        zip -r $func.zip virtualenv; zip -j $func.zip $func/redis/__main__.py 
        mv $func.zip $func/
...
if $run; then 
    ...
    do 
        ...
        wsk -i action create --docker python2action $func $func.zip 
        ...
        do 
            ...
            wsk -i action invoke --blocking $func --param url $1 img $imgNames  2>&1 | tee faascache.results.$func._$imgNames 
        done 
