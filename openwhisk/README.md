...
The invoker component is modified to send a notification on a UNIX socket when it creates or removes a Docker container.
This is used by FaaSLoad's Docker monitor.
The modification (beside minor ones to make it work), is to add shim scripts to the container image of the invoker component:
the scripts "docker" and "docker-runc" in "core/invoker".

## Contents of the original README file
